...
function TemperatureAndDetails({weather: {details, icon, temp, temp_min, temp_max, sunrise, sunset, speed, humidity,
feels_like, timezone}}) {
  return (
    <div>
        ...
        <div className="flex flex-row items-center justify-between text-white py-3">
            ...
            <div className="flex flex-col space-y-2">
                <div className="flex font-light text-sm items-center justify-center">
                    ...
                    Real Feel :
                    <span className='font-small ml-1'>{`${feels_like}°`}</span>
                </div>
                <div className="flex font-light text-sm items-center justify-center">
                    <UilTear size={20} className="mr-0.5"/>
                    Humidity :
                    <span className='font-small ml-1'>{`${humidity}%`}</span>
                </div>
                <div className="flex font-light text-sm items-center justify-center">
                    <UilWind size={20} className="mr-1"/>
                    Wind :
                    <span className='font-small ml-1'>{`${speed}km/h`}</span>
                </div>
            </div>
        </div>
